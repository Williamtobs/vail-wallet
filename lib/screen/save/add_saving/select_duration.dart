...
import 'package:vail_wallet/screen/save/add_saving/review_saving_details.dart';
...
class SavingDuration extends StatelessWidget {
  SavingDuration({Key? key}) : super(key: key);
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                            'For how long do you want to Save money?',
                            style: GoogleFonts.mulish(
                                fontSize: 14,
                                fontWeight: FontWeight.w700,
                                color: Colors.black)),
