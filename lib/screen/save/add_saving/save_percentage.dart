...
import 'package:vail_wallet/screen/save/add_saving/select_duration.dart';
import 'package:vail_wallet/screen/widgets/button.dart';

import '../../widgets/input_field.dart';


class AddSavePercentage extends StatelessWidget {
  AddSavePercentage({Key? key}) : super(key: key);
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                            'How many percent of your Income you want to save?',
                            style: GoogleFonts.mulish(
                                fontSize: 14,
                                fontWeight: FontWeight.w700,
                                color: Colors.black)),
